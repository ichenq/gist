...
#include "msjexhnd.h"
//#include <psapi.h>			//use GetProcessMemoryInfo()
												  ...
												  PEXCEPTION_POINTERS pExceptionInfo )
{
	...
	_tprintf(_T("Timestamp: %d-%02d-%02d  %02d:%02d:%02d"), 
		SysTime.wYear, SysTime.wMonth, SysTime.wDay,
		SysTime.wHour, SysTime.wMinute, SysTime.wSecond);
	//CTime tmNow = CTime::GetCurrentTime();
	//_tprintf( _T("Timestamp: %s \n"), tmNow.Format(_T("%Y-%m-%d %H:%M:%S")));
...
//	_tprintf(_T("System physical memory: %d/%d \n System virtual memory: %d/%d \n"),
//		memStatus.dwAvailPhys,
//		memStatus.dwTotalPhys,
//		memStatus.dwAvailVirtual,
//		memStatus.dwTotalVirtual);
//
//	// Retireve process memory information
//	PROCESS_MEMORY_COUNTERS pmc;
//    pmc.cb = sizeof(PROCESS_MEMORY_COUNTERS);
//    if ( GetProcessMemoryInfo( GetCurrentProcess(), &pmc, sizeof(pmc)) )
//    {
//		_tprintf(_T("Process used memory: %d/%d"),
//			pmc.PagefileUsage,
//			pmc.PeakPagefileUsage);
//	}
//	else
//	{
//		_tprintf(_T("can't retrieve process memory information, error code : %d"), GetLastError());
//	}
